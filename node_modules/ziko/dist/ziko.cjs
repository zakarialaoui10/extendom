...
var Events = /*#__PURE__*/Object.freeze({
    ...
    ZikoEvent: ZikoEvent,
    ZikoEventClick: ZikoEventClick,
    ZikoEventClipboard: ZikoEventClipboard,
    ZikoEventHash: ZikoEventHash,
    ZikoEventInput: ZikoEventInput,
    ZikoEventKey: ZikoEventKey,
    ZikoEventMouse: ZikoEventMouse,
    ZikoEventPointer: ZikoEventPointer,
    ZikoEventSwipe: ZikoEventSwipe,
    ZikoEventWheel: ZikoEventWheel,
    useClickEvent: useClickEvent,
    useClipboardEvent: useClipboardEvent,
    useCustomEvent: useCustomEvent,
    useDragEvent: useDragEvent,
    useDropEvent: useDropEvent,
    useFocusEvent: useFocusEvent,
...
let ZikoUseEventEmitter$1 = class ZikoUseEventEmitter {
    constructor() {
      this.events = {};
...
const useEventEmitter$1=()=>new ZikoUseEventEmitter$1();
...
let ZikoUseFavIcon$1 = class ZikoUseFavIcon{
    ...
    useEventEmitter(){
        this.cache.Emitter=useEventEmitter$1();
        return this;
    }
...
let ZikoUseChannel$1 = class ZikoUseChannel{
    constructor(name=""){
...
const useChannel$1=name=>new ZikoUseChannel$1(name);
...
const gamma=(...x)=>mapfun$1(_gamma,...x);
...
const bessel=(n,x)=>{
    if(typeof n === "number"){
        ...
        if(typeof x === "number") return mapfun$1(a=>_bessel(a,x),...n);
        else if(x instanceof Array){
            const Y=[];
            for(let i=0;i<n.length;i++){
                Y.push(mapfun$1(a=>_bessel(n[i],a),...x));
            }
            return Y;
        }
    }
...
const beta=(x,y)=>{
    if(typeof x === "number"){
        ...
        if(typeof y === "number") return mapfun$1(a=>_beta(a,y),...x);
        else if(y instanceof Array){
            const Z=[];
            for(let i=0;i<x.length;i++){
                Z.push(mapfun$1(a=>_beta(x[i],a),...y));
            }
            return Z;
        }
    }
...
var __Calculus__ = /*#__PURE__*/Object.freeze({
    __proto__: null,
    bessel: bessel,
    beta: beta,
    gamma: gamma
...
var JsonStyleSheet = /*#__PURE__*/Object.freeze({
    __proto__: null,
    ZikoJsonStyleSheet: ZikoJsonStyleSheet,
    jsonStyleSheet: jsonStyleSheet
});
...
exports.jsonStyleSheet = jsonStyleSheet;
exports.lerp = lerp;
exports.li = li;
exports.link = link;
